...
public class DatabaseManager extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_ALUMNO_TABLE = "CREATE TABLE " + TABLE_ALUMNO + "("
                ...
                + COLUMN_CARRERA + " TEXT,"  // Nueva columna
                + COLUMN_FOTO + " BLOB"
                + ")";
    ...
    public void agregarAlumno(String nombre, String matricula, String carrera, byte[] foto) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(COLUMN_NOMBRE, nombre);
        values.put(COLUMN_MATRICULA, matricula);
        values.put(COLUMN_CARRERA, carrera);  // Nueva columna
    ...
    public Alumno obtenerAlumnoPorId(int alumnoId) {
        ...
        Cursor cursor = db.query(
                TABLE_ALUMNO,
                new String[] { COLUMN_ID, COLUMN_NOMBRE, COLUMN_MATRICULA, COLUMN_CARRERA, COLUMN_FOTO },
                COLUMN_ID + "=?",
        ...
        if (cursor != null && cursor.moveToFirst()) {
            ...
            if (columnIndexId != -1 && columnIndexNombre != -1 && columnIndexMatricula != -1 && columnIndexCarrera != -1 && columnIndexFoto != -1) {
                alumno = new Alumno(
    ...
    public void actualizarAlumno(Alumno alumno) {
        ...
        values.put(COLUMN_CARRERA, alumno.getCarrera());  // Nueva columna
    ...
    public List<Alumno> buscarAlumnos(String query) {
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM " + TABLE_ALUMNO +
                ...
                COLUMN_MATRICULA + " LIKE '%" + query + "%' OR " + COLUMN_CARRERA +
                " LIKE '%" + query + "%'", null);
        ...
        if (cursor != null && cursor.moveToFirst()) {
            ...
            do {
                Alumno alumno = new Alumno(); // Agregar esta línea
